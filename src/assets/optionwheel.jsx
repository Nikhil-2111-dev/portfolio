...
const OptionWheel = ({
  ...
  // Wheel / touchpad scrolling - disabled per user request as it was too fast
  useEffect(() => {
  ...
  // Auto-rotate with an appropriate delay
  useEffect(() => {
    // 2500ms delay for auto-rotation
